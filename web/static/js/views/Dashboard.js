    ...
    <div class="bg-cyan-50">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            ...
            <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                <div>
                    <label for="search" class="block text-sm font-medium text-gray-700">嘗試搜尋一些東西吧？</label>
                    <div class="mt-1 relative rounded-md shadow-sm inline-flex shadow">
                        <input type="text" name="search" id="search"
                            class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-12 py-3 sm:text-sm border-gray-300 rounded-md"
                            placeholder="例如：王力宏...">
                    </div>
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-base text-blue-600 font-semibold tracking-wide uppercase">特色</h2>
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">高效率的爬蟲系統</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
                            Climate 利用了 Scrapy 框架，提供了高效率的捕捉速度，讓資料能快速的被整理並寫入資料庫內。
                        </dd>
                    </div>
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">三種資料來源</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
                            我們使用 PTT、Dcard、巴哈姆特 作為資料來源，進行分析與解構，整理出資料提供使用者閱覽。
                        </dd>
                    </div>
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">穩定的資料庫系統</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">漂亮的操作介面</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
    ...
    <div class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
            ...
            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                這是一份來自國立高雄科技大學的實驗專案，這是一項實驗項目，用於分析臺灣社群網路趨勢及聲量，類似Google Trends，並以開放原始碼的方式呈現。
            </p>
